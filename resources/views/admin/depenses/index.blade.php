...
@section('content')
    ...
    <form class="row g-2 mb-3">
        <div class="col-6 col-md-2"><input type="date" class="form-control" name="du" value="{{ $du }}"></div>
        <div class="col-6 col-md-2"><input type="date" class="form-control" name="au" value="{{ $au }}"></div>
        <div class="col-12 col-md-3"><input class="form-control" name="categorie" value="{{ $categorie }}" placeholder="Categorie"></div>
